...
const playNotificationSound = () => {
  try {
    if (
      ...
      localStorage.getItem("app-notif-muted") === "true"
    )
      return;
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    console.log(
      `[Dashboard Polling] Check: Current=${currentUnread}, Prev=${prevUnreadRef.current}`,
    );

    if (
      prevUnreadRef.current !== undefined &&
      currentUnread > prevUnreadRef.current
    ) {
      console.log(
        "[Dashboard Polling] NEW MESSAGE DETECTED! Triggering sound...",
      );
  ...
  return (
    <div style={{ background: "var(--surface-bg)", minHeight: "100dvh" }}>
      ...
      <header
        ...
        style={{
          background:
            "linear-gradient(135deg, #06c755 0%, #049a42 50%, #037d36 100%)",
            ...
            >
              <CardContent style={{ padding: "20px" }}>
                ...
                >
                  ...
                  <ChevronRight
                    size={18}
                    style={{ color: "var(--neutral-400)", marginLeft: 8 }}
                  />
                </div>
                <div
                  style={{
          ...
          >
            <CardContent style={{ padding: "20px" }}>
              ...
              <Button
                ...
                variant="outline"
                className="w-full h-10 text-[13px] border rounded-xl"
                style={{
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      >
                        ...
                        />
                        <span>
                          {new Date(hist.date).toLocaleTimeString("th-TH", {
                            hour: "2-digit",
                            minute: "2-digit",
                          })}{" "}
