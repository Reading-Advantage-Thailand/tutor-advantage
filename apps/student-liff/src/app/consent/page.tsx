      ...
      <main style={{ flex: 1, maxWidth: "768px", margin: "0 auto", width: "100%", padding: "24px 16px 80px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          {consents.map((consent) => (
            <Card key={consent.id} className="glass-card" style={{ padding: "16px", border: "1px solid var(--surface-border)" }}>
              <div style={{ display: "flex", gap: "14px" }}>
                <div style={{ 
                  width: "40px", 
                  height: "40px", 
                  borderRadius: "10px", 
                  background: consent.status === "ACTIVE" ? "var(--accent-emerald-light)" : "var(--neutral-100)", 
                  display: "flex", 
                  alignItems: "center", 
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "8px", marginBottom: "4px" }}>
                    ...
                    <span style={{ 
                      ...
                      padding: "2px 8px", 
                      borderRadius: "6px",
                      background: consent.status === "ACTIVE" ? "rgba(16, 185, 129, 0.1)" : "rgba(107, 114, 128, 0.1)",
                      color: consent.status === "ACTIVE" ? "rgb(5, 150, 105)" : "var(--text-secondary)"
                    }}>
                      {consent.status === "ACTIVE" ? "ยินยอมแล้ว" : "ยังไม่ยินยอม"}
                    </span>
                  </div>
                  ...
                  {consent.status === "ACTIVE" && (
                    <div style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "0.75rem", color: "var(--text-tertiary)" }}>
                      <Calendar size={12} />
                      <span>ยินยอมเมื่อ: {consent.date}</span>
                    </div>
                  )}
                </div>
              </div>
        ...
        <div style={{ 
          ...
          <div>
            <h4 style={{ fontSize: "0.875rem", fontWeight: 600, color: "rgb(180, 83, 9)", marginBottom: "4px" }}>การเพิกถอนความยินยอม</h4>
        ...
        <div style={{ marginTop: "40px", textAlign: "center", display: "flex", flexDirection: "column", gap: "12px" }}>
          ...
          <Link href="/terms" style={{ fontSize: "0.8125rem", color: "var(--brand-600)", textDecoration: "none", fontWeight: 500 }}>
            อ่านเงื่อนไขการให้บริการฉบับเต็ม
          </Link>
        </div>
