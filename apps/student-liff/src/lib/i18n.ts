export const th = {
  ...
  dashboard: {
    ...
    selectClass: "เลือกคลาส",
    referralPickerTitle: "เลือกคลาสที่จะชวน",
    referralPickerSubtitle: "ระบบจะคัดลอกลิงก์สมัครของคลาสที่เลือก",
    quickMenu: "เมนูด่วน",
  ...
  notifications: {
    ...
    lineNotConnectedDescription: "เข้าสู่ระบบด้วย LINE เพื่อรับ Push Message",
    ...
    lineMessages: "ข้อความจากครู",
    lineMessagesDescription: "แจ้งเตือนเมื่อครูส่งข้อความใหม่",
    ...
    loadFailed: "โหลดการตั้งค่าจากระบบไม่สำเร็จ ค่าที่แสดงอาจไม่ใช่ค่าล่าสุด",
    saving: "กำลังบันทึก...",
  ...
  interactivePlay: {
    ...
    gamePreparing: "กำลังเตรียมเกม...",
    gameComplete: "เล่นเกมเสร็จแล้ว",
    gameWaitTeacher: "รอคุณครูไปหน้าถัดไป",
    gameVoteTitle: "โหวตเกมที่อยากเล่น",
    vocabularyGame: "เกมคำศัพท์",
    sentenceGame: "เกมประโยค",
    gameCategoryVocab: "คำศัพท์",
    gameCategorySentence: "ประโยค",
    gameCard: "การ์ดเกม",
    selected: "เลือกแล้ว",
    voteDone: "โหวตแล้ว",
    chooseThisGame: "เลือกเกมนี้",
    comingSoon: "เร็วๆนี้",
    yourVote: "เกมที่คุณเลือก",
    noGameSelected: "ยังไม่ได้เลือกเกม",
    getReady: "เตรียมตัว",
    gameStartsAutomatically: "เกมจะเริ่มอัตโนมัติ",
    lessonGame: "เกมบทเรียน",
    score: "คะแนน",
    matchVocabulary: "จับคู่คำศัพท์",
    buildSentence: "สร้างประโยค",
    chooseCorrectAnswer: "เลือกคำตอบที่ถูกต้อง",
    brewCorrectAnswer: "ผสมคำตอบที่ถูกต้อง",
    activateCorrectRune: "เปิดรูนคำตอบที่ถูกต้อง",
    escapeCorrectAnswer: "หนีออกมาด้วยคำตอบที่ถูกต้อง",
  ...
  classes: {
    ...
    detail: {
      ...
      lessonSampleTitle: "ตัวอย่างบทเรียนจริง",
      lessonSampleBadge: "ตัวอย่าง",
      lessonNumberPrefix: "บทที่",
      lessonSamplePassage: "บทความ",
      lessonSampleSummary: "สรุปเนื้อหา",
      lessonSampleReadFull: "อ่านบทเรียนเต็ม",
      lessonSampleReadPreview: "ดูตัวอย่างบทเรียน",
      lessonSampleLocked: "ปลดล็อกหลังสมัครเรียน",
      lessonSampleEnrollCta: "สมัครเรียนเพื่ออ่านทุกบท",
      lessonCompleted: "เรียนแล้ว",
      ...
      reviewPlaceholder: "เล่าความประทับใจหรือข้อเสนอแนะเพิ่มเติม",
      reviewCancel: "ยกเลิก",
      reviewSaving: "กำลังบันทึก...",
      reviewSaveEdits: "บันทึกการแก้ไข",
      reviewSubmit: "ส่งรีวิว",
      reviewStarPrefix: "ให้",
      reviewStarSuffix: "ดาว",
      shareSuccess: "คัดลอกลิงก์แล้ว",
      shareFailed: "ไม่สามารถแชร์ได้",
      upgradeNextBookPrefix: "เรียนต่อเล่ม",
      reviewSelectStarFirst: "กรุณาเลือกจำนวนดาวก่อนส่งรีวิว",
      reviewSaveSuccess: "บันทึกรีวิวเรียบร้อยแล้ว",
      reviewSaveFailed: "บันทึกรีวิวไม่สำเร็จ",
