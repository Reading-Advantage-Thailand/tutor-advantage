...
export const studentEnrollment = withStudentRole(async (req: NextRequest, user: User) => {
...
export const studentReEnrollment = withStudentRole(async (req: NextRequest, user: User) => {
  const body = await req.json();
