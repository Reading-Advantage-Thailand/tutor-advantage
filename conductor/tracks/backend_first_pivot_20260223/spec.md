...
This track establishes production-grade backend and admin finance foundations before mobile app releases.
...
- Each class package maps to exactly one book.
...
- Activity eligibility: at least one successful paid enrollment in settlement month.
...
- Tutor/student mobile app UX implementation beyond backend contract needs in this track
