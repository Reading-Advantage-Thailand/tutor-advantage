...
const mockArticles = {
    "art-001": {
        ...
        passage: "Octopuses are intelligent creatures that can solve problems and hide from predators. They have three hearts and blue blood. They can change their color and texture to blend in with their surroundings.",
        cefr_level: "A1",
        ra_level: "Level 1",
        words: [
            {
    ...
    "art-002": {
        ...
        passage: "Recycling helps reduce waste and protects our environment for future generations. By recycling paper, plastic, and glass, we can conserve natural resources and reduce pollution.",
        cefr_level: "A2",
        ra_level: "Level 2",
        words: [
            {
    ...
    "art-003": {
        ...
        passage: "Coffee originated in Ethiopia and has become the most popular beverage worldwide. Millions of people drink coffee every morning to feel energized.",
        cefr_level: "B1",
        ra_level: "Level 3",
        words: [
            {
