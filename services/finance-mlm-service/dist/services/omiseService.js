...
exports.retrieveOmiseTransfer = retrieveOmiseTransfer;
...
async function retrieveOmiseTransfer(transferId) {
    return omiseRequest(`/transfers/${encodeURIComponent(transferId)}`, {
        method: "GET",
    });
}
